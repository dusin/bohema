...
<path class="text-primary" d="M62.0254 15.4219H64.418V18H62.0254V15.4219Z" transform="translate(0 -3)" fill="#9A6EE2"/>
		  ...
		  <div class="collapse navbar-collapse" id="navbarCollapse">
			<ul class="navbar-nav mx-auto">
			  <li class="nav-item dropdown"><a class="nav-link dropdown-toggle " id="homeDropdownMenuLink" href="index.html" data-bs-target="#" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
				   Home        </a>
	...
	<!-- Hero Section-->
	<section class="mh-full-screen dark-overlay py-7 d-flex align-items-center justify-content-center"><img class="bg-image" src="https://d19m59y37dris4.cloudfront.net/sell/2-0-1/img/photo/photo-1534126511673-b6899657816a.jpg" alt="">
	  <div class="overlay-content w-100">
		<div class="container">
		  <div class="row">
			<div class="col-xl-6 text-white">
			  <h6 class="text-uppercase text-white letter-spacing-5 mb-3">O Bohémě</h6>
			  <h1 class="display-3 fw-bold text-shadow mb-5">Objevujte s námi české dědictví</h1>
			  <p class="text-lg">Vlastenectví a láska k vlasti byly za první republiky ctností. Naším cílem je to národu připomínat a rozvíjet. Zabýváme se tvorbou a prodejem produktů, které oslavují české dědictví.</p>
			</div>
		  </div>
		</div>
	  </div>
		...
		<div class="row">
		  <div class="col-lg-6 about-text-column bg-gray-100">
			<div class="about-text">
			  ...
			  <p class="text-lg text-muted">Za tři roky jsme vytvořili řadu triček, mikin, hraček a dalších výrobků. Je pro nás klíčové, aby naše produkty měly vysokou estetickou hodnotu. Spolupracujeme s nadanými výtvarníky, pátráme v archivech, spolupracujeme s dědici osobnostních a uměleckých práv. Podporujeme české výrobce a u textilu hledíme na ekologii, fair-trade a odpovědnou výrobu.</p>
			</div>
		  </div>
		  <div class="col-lg-6 p-lg-0 about-image-column"><img class="bg-image" src="https://www.mojebohema.cz/wp-content/uploads/2022/09/mood-board-mockup-with-different-size-papers-placed-together-3866-el1-1-e1664217081561.jpg" alt=""></div>
		</div>
		<div class="row">
		  <div class="col-lg-6 about-text-column order-lg-2">
			<div class="about-text">
			  ...
			  <p class="text-lg text-muted">Při příležitosti oslav sta let republiky jsme chtěli dát najevo, jak si vážíme naší vlasti, svobody a českého národa. Nenašli jsme ale žádné oblečení, které by reflektovalo naši historii s dávkou pokory, úcty a vkusu zároveň. Proto jsme vytvořili první designy triček. Zájem o ně předčil očekávání a utvrdil nás v tom, že lidé dají lásku k vlasti rádi najevo, pokud to mohou udělat elegantně.. Uplynuly tři roky a nyní máme v nabídce více než čtyřicet motivů triček. A nejen ty! Bohému postupně rozšiřujeme o další produkty, které spojuje téma Česko a češství. Je to skutečně krásná práce, která propojuje historii se současností. Každý produkt v sobě totiž ukrývá příběh českého dědictví. Eliška a Oldřich Neubergerovi              </p>
			</div>
		  </div>
		  <div class="col-lg-6 p-lg-0 about-image-column order-lg-1"><img class="bg-image" src="https://www.mojebohema.cz/wp-content/uploads/elementor/thumbs/Untitled-8-pzp8e67w0s6enikcfcbj6p94xbo6d39hrtvzgocnyo.jpg" alt=""></div>
		</div>
		<div class="row">
		  <div class="col-lg-6 about-text-column bg-gray-100">
			<div class="p-5">
			  <blockquote class="mb-5">
				<p class="text-xl text-serif mb-4">Krásné a originální motivy, skvěle sedící velikost, velmi příjemný materiál, ultra rychlé doručení snad za den a půl, a hlavně, nosná (doslova) myšlenka. Moc děkuji.  </p>
				<h6 class="text-lg text-uppercase text-primary">— Anežka H., ⭐⭐⭐⭐⭐</h6>
			  </blockquote>
			  <p class="text-lg text-muted">JAK SE VÁM TRIČKA LÍBÍ? Bohému děláme pro vás a vaše zpětná vazba je pro nás nejdůležitější.  </p>
			</div>
		  </div>
		  <div class="col-lg-6 p-lg-0 about-image-column"><img class="bg-image" src="https://d19m59y37dris4.cloudfront.net/sell/2-0-1/img/photo/marco-xu-496929-unsplash.jpg" alt=""></div>
		</div>
	  </div>
	</section>
	<section class="py-6">
	  <div class="container">
		<div class="row">
		  <div class="col-lg-5">
			<h6 class="text-uppercase text-muted letter-spacing-5 mb-1">CO VŠECHNO U NÁS NAJDETE</h6>
			<h2 class="mb-4">Jak tvoříme naše motivy?</h2>
			<p class="text-lg text-muted">Naše motivy na tričkách jsou různorodé a vybrat „to své“ si může opravdu každý. Pro náměty hledáme nadané výtvarníky, pátráme v archivech, spolupracujeme s dědici práv. Na jeden povedený motiv připadají desítky nepovedených nebo vyřazených. Za každým naším výrobkem se ukrývá spousta práce, vzorování a testování. Věříme, že právě díky tomu se nám daří držet laťku vysoko. </p>
		  </div>
		  <div class="col-lg-6 ms-lg-auto">
			<div class="row">
			  <div class="col-sm-6 mb-4">
				<h4>Vlastní motivy</h4>
				<p class="text-muted">Vymýšlíme vlastní designy,
					které pro nás vytváří umělci na zakázku. </p>
			  </div>
			  <div class="col-sm-6 mb-4">
				<h4>2000</h4>
	  ...
	  <div class="container">
		<div class="row justify-content-center">
		  <div class="col-lg-6 d-flex align-items-center">
			<div class="w-100"><img class="img-fluid" src="https://d19m59y37dris4.cloudfront.net/sell/2-0-1/img/photo/christopher-campbell-28571-unsplash.jpg" alt=""></div>
		  </div>
		  <div class="col-lg-5 d-none d-lg-block"><img class="img-fluid" src="https://d19m59y37dris4.cloudfront.net/sell/2-0-1/img/photo/noah-buscher-400915-unsplash.jpg" alt=""></div>
		</div>
	  </div>
	</section>
	<section class="py-6">
	  <div class="container">
		<div class="row">
		  <div class="col-lg-8 mx-auto">
			<h2 class="mb-6">Na kvalitě si zakládáme</h2>
		  </div>
		  <div class="col-lg-6">
			<p class="text-lg text-muted">Prošli jsme stovky druhů a značek triček, než jsme našli to pravé. Chtěli jsme skvělý materiál a střih, který by padnul všem. Hledali jsme tričko finančně dostupné a s dohledatelným původem. Kontrolovaná ekologická výroba pro nás byla prioritou. A tady je!
				
				 
				
				Belgická fair trade značka, která splnila všechna naše očekávání. Vyznává hodnoty odpovědné výroby, udržitelných materiálů a nadčasové kvality. Věříme, že i vy budete nadšení.</p>
		  </div>
		  <div class="col-lg-6"> 
			<p class="text-lg text-muted">Naše skvěle padnoucí kvalitní trička z organické bavlny mají certifikáty GOTS, OEKO-TEX a PETA VEGAN APPROVED. Co tyhle nesrozumitelné značky znamenají? Především to, že se nemusíte stydět za to, co nosíte. Ekologicky přemýšlíme nejen u triček a technologie potisku, ale i u balení, které se snažíme mít co nejvíce kompaktní a pouze z přírodních materiálů. Vše je také uzpůsobeno k následné další recyklaci. </p>
		  </div>
		</div>
	  </div>
	</section>
