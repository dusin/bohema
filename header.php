		  ...
		  <div class="row d-flex align-items-center">
			...
			<div class="col-sm-5 d-flex justify-content-end">
			  ...
			  <div class="dropdown border-end px-3"><a class="dropdown-toggle topbar-link" id="langsDropdown" href="#" data-bs-toggle="dropdown" data-bs-display="static" aria-haspopup="true" aria-expanded="false"><img class="topbar-flag" src="https://d19m59y37dris4.cloudfront.net/sell/2-0-1/img/flag/gb.svg" alt="english">English</a>
				<div class="dropdown-menu dropdown-menu-end dropdown-menu-animated" aria-labelledby="langsDropdown"><a class="dropdown-item text-sm" href="#"><img class="topbar-flag" src="https://d19m59y37dris4.cloudfront.net/sell/2-0-1/img/flag/de.svg" alt="german">German</a><a class="dropdown-item text-sm" href="#"> <img class="topbar-flag" src="https://d19m59y37dris4.cloudfront.net/sell/2-0-1/img/flag/fr.svg" alt="french">French</a></div>
			  </div>
...
<path class="text-primary" d="M62.0254 15.4219H64.418V18H62.0254V15.4219Z" transform="translate(0 -3)" fill="#9A6EE2"/>
		  ...
		  <div class="collapse navbar-collapse" id="navbarCollapse">
			<ul class="navbar-nav mx-auto">
			  ...
			  <li class="nav-item dropdown position-static"><a class="nav-link dropdown-toggle " href="#" data-bs-toggle="dropdown">Eshop</a>
					...
					<div class="row">
					  <div class="col-lg-9">
						<div class="row p-3 pe-lg-0 ps-lg-5 pt-lg-5">
						  <div class="col-lg-3">
							<!-- Megamenu list-->
							<h6 class="text-uppercase">Trička</h6>
							  <ul class="megamenu-list list-unstyled">
								<li class="megamenu-list-item"><a class="megamenu-list-link" href="index.html">Dámské   </a></li>
								<li class="megamenu-list-item"><a class="megamenu-list-link" href="index2.html">Pánské   </a></li>
							  </ul>
							<!-- Megamenu list-->
							<!-- Megamenu list-->
							  <h6 class="text-uppercase">Mikiny</h6>
							  <ul class="megamenu-list list-unstyled">
								<li class="megamenu-list-item"><a class="megamenu-list-link" href="index.html">Dámské   </a></li>
								<li class="megamenu-list-item"><a class="megamenu-list-link" href="index2.html">Pánské   </a></li>
								</ul>
						  ...
						  <div class="col-lg-3">
							<!-- Megamenu list-->
							<!-- Megamenu list-->
							  <h6 class="text-uppercase">Ostatní</h6>
							  <ul class="megamenu-list list-unstyled">
								<li class="megamenu-list-item"><a class="megamenu-list-link" href="cart.html">Papírnictví</a></li>
								<li class="megamenu-list-item"><a class="megamenu-list-link" href="cart-2.html">Plakáty</a></li>
								<li class="megamenu-list-item"><a class="megamenu-list-link" href="checkout1.html">Knihy   </a></li>
								<li class="megamenu-list-item"><a class="megamenu-list-link" href="checkout2.html">Sklo   </a></li>
								<li class="megamenu-list-item"><a class="megamenu-list-link" href="checkout3.html">Tašky   </a></li>
								<li class="megamenu-list-item"><a class="megamenu-list-link" href="checkout4.html">Placky     </a></li>
							  </ul>
						  </div>
						  <div class="col-lg-3">
							<!-- Megamenu list-->
							<h6 class="text-uppercase">Pro koho</h6>
							  <ul class="megamenu-list list-unstyled">
								<li class="megamenu-list-item"><a class="megamenu-list-link" href="contact.html">Pro ženy   </a></li>
								<li class="megamenu-list-item"><a class="megamenu-list-link" href="contact-2.html">Pro muže  </a></li>
								<li class="megamenu-list-item"><a class="megamenu-list-link" href="text.html">Pro děti</a></li>
							  </ul>
							<!-- Megamenu list-->
							<h6 class="text-uppercase">Výběry</h6>
							  <ul class="megamenu-list list-unstyled">
								<li class="megamenu-list-item"><a class="megamenu-list-link" href="customer-login.html">Novinky  </a></li>
								<li class="megamenu-list-item"><a class="megamenu-list-link" href="customer-orders.html">Nejprodávanější   </a></li>
								<li class="megamenu-list-item"><a class="megamenu-list-link" href="customer-order.html">Slevy</a></li>
							  </ul>
						  </div>
			  ...
			  <li class="nav-item"><a class="nav-link" href="/palackeho/">Prodejna</a>
			  
			  <li class="nav-item dropdown"><a class="nav-link dropdown-toggle" id="navbarDropdownMenuLink" href="#" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">O nás</a>
				<ul class="dropdown-menu dropdown-menu-animated" aria-labelledby="navbarDropdownMenuLink">
				  <li><a class="dropdown-item" href="/o-nas/caste-otazky">Časté otázky</a></li>
				  <li><a class="dropdown-item" href="/blog/">Blog</a></li>
				  
				</ul>
			  </li>
			  <!-- Multi level dropdown end-->
			  <li class="nav-item"><a class="nav-link" href="/o-nas/kontakt/">Kontakt</a>
			  </li>
